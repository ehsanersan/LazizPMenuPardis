...
export const menuItems: MenuItem[] = [
  ...
  { id:"b5", day:5, meal:"breakfast", name:"حلوا شکری و پنیر",     price:950000,  description:"حلوا شکری خانگی همراه با پنیر صبحانه",                   fullDescription:"حلوا شکری خانگی با طعمی اصیل همراه با پنیر لیقوان، سرو شده با نان تازه. ترکیبی دلچسب از شیرینی و شوری.", image: siteImages.breakfast.halvaCheese,          hasRice:false, tags:["صبحانه","سنتی"] },
  ...
  { id:"d8", day:8, meal:"dinner", name:"خوراک مرغ و سبزیجات",    price:5250000, description:"مرغ گریل با سبزیجات فصل",                     fullDescription:"تکه‌های مرغ گریل‌شده همراه با سبزیجات فصل سوته شده. غذایی سبک و سالم.", image: siteImages.dinner.chickenVegetables, hasRice:false, tags:["شام","مرغ","سالم"] },
];
